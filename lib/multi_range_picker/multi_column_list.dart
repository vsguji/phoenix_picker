...
import 'multi_column_picker_item.dart';
...
class _MultiColumnListWidgetState extends State<MultiColumnListWidget> {
  @override
      ...
      child: Container(
        ...
        child: ListView.separated(
          ...
          itemBuilder: (BuildContext context, int index) {
            ...
            return MultiRangePickerCommonItem(
              item: item,
  ...
  void _processFilterData(BrnPickerEntity? selectedEntity) {
    ...
    if (selectedEntity.filterType == PickerFilterType.checkbox &&
      ...
      if (!MultiColumnPickerUtil.isSelectedCountExceed(selectedEntity)) {
        PhoenixToast.show(
    ...
    int totalLevel = MultiColumnPickerUtil.getTotalColumnCount(selectedEntity);
