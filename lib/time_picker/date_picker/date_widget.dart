...
enum ColumnDateType { year, month, day }
...
class DateWidget extends StatefulWidget {
  ...
  State<StatefulWidget> createState() =>
      _DateWidgetState(minDateTime, maxDateTime, initialDateTime);
}
...
class _DateWidgetState extends State<DateWidget> {
  ...
  Widget _renderDatePickerItemComponent(
      ColumnDateType columnType, int index, int value, String format) {
    TextStyle textStyle = widget.themeData!.itemTextStyle.generateTextStyle();
    if ((ColumnDateType.year == columnType &&
            index == _calcSelectIndexList()[0]) ||
        (ColumnDateType.month == columnType &&
            index == _calcSelectIndexList()[1]) ||
        (ColumnDateType.day == columnType &&
