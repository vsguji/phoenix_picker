...
class TimeRangeSideWidget extends StatefulWidget {
  /// 可选最小时间
  ...
  State<StatefulWidget> createState() => _TimePickerWidgetState(minDateTime,
      maxDateTime, initialStartDateTime, minuteDivider, onInitSelectChange);
}

class _TimePickerWidgetState extends State<TimeRangeSideWidget> {
