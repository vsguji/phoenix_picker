...
typedef MultiDataPickerCreateWidgetCallback = Widget Function(
...
class MultiDataPicker extends StatefulWidget {
  ...
  final MultiDataPickerDelegate delegate;
  ...
  final MultiDataPickerCreateWidgetCallback? createItemWidget;
...
class _BrnMultiDataPickerState extends State<MultiDataPicker> {
...
/// 实现了部分默认逻辑的 Delegate
class BrnDefaultMultiDataPickerDelegate implements MultiDataPickerDelegate {
  ///数据源
