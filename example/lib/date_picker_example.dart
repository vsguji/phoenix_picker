...
//  }
  ...
  _showRangePickerNoLimited(
    ...
    format = 'HH时:mm分';
    PickerTitleConfig timePickerTheme = PickerTitleConfig(
        title: PickerTitleConfig.Default.title,
        showTitle: pickerShowTitleDefault,
        titleContent: "选择时间范围");
    DateRangePicker.showDatePicker(context,
        minDateTime: DateTime.parse(MIN_DATETIME),
        maxDateTime: DateTime.parse(MAX_DATETIME),
        pickerMode: mode,
    ...
    switch (mode) {
      case BrnDateTimeRangePickerMode.date:
        ...
        PickerTitleConfig pickerTitleConfig =
            PickerTitleConfig(titleContent: "选择时间范围");
        DateRangePicker.showDatePicker(context,
            isDismissible: false,
            minDateTime: DateTime.parse(MIN_DATETIME),
            maxDateTime: DateTime.parse(MAX_DATETIME),
